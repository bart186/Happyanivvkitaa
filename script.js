  ...
  const mapData = {
    0: [
      ...
      { element: 'tree', angle: 70, offset: 20, color: 'navy' },
      {
        ...
        color: 'gold',
        display: {
          caption: 'camat datang sayang didunia kecil buatan pacar spesial aniv,ada banyak hal lucu disana semoga menyenangkan ya jangan lupa aturannya harus klik yg berbeda gambar'
        }
      },
      { 
        element: 'house2', angle: 110, offset: 30,
        display: {
          caption: `Hi cantik aku punya sesuatu di aniv kita ,kamu nak liat?`,
          link: linkButton('https://bart186.github.io/Text-for-u/', 'nak nak nak'),
          button: 'gamau ah'
        } 
      },
      ...
      { 
        ...
        display: {
          ...
          caption: 'Hi there! happy aniv yaa semoga kita selalu tetep bersama! (Hint: look for things with faces)',
        }, 
      },
    ...
    1: [
      ...
      { 
        ...
        display: {
          ...
          link: linkButton('https://id.shp.ee/Ke4xbjZ/', `mau ayangg!`),
        } 
      },
      ...
      { element: 'tree', angle: 75, offset: 20 },
      {
        ...
        display: {
          ...
          link: linkButton('https://codepen.io/cassie-codes/full/eYmXozM', `iyahh ayanggmah`)
        },
      },
      {
        ...
        display: {
          ...
          caption: 'susun game ini ,berhasil dapet mamam kesukaan 4x kesempatan',
          link: linkButton('https://codepen.io/Ma5a/full/MWrZPOP', 'wow mauu!')
        },
      },
      { 
    ...
    2: [
      ...
      { 
        ...
        display: { caption: `Hello, aku adalah matahari yg selalu mau menyinari hidup kamu dan wajah   ceria kamu.` },
      },
      { 
    ...
    4: [
      ...
      { element: 'cactus', angle: 50, offset: 60, color: 'navy' },
      {
        ...
        display: {
          ...
          link: linkButton('', `yeah, I'm into that sort of thing`)
        },
      },
      {
        ...
        display: {
          ...
          caption: `ayo bantu mereka`,
          link: linkButton('https://codepen.io/Ma5a/full/LYQoLNR', `apaa INII?`),
          button: 'meh'
        },
      },
      { 
    ...
    5: 
      ...
      { 
        ...
        display: {
          caption: `TETEP MENCINTAIKU YA MESKI KITA LAGI GABAIK BAIK ☹️.`,
        },
      },
      ...
      { 
        ...
        display: {
          ...
          caption: 'aku punya peliharaan bisa diajak main taukk ,nak liat ga?',
          link: linkButton('https://codepen.io/Ma5a/full/BapbQam', `mau,harus di pencet ya biar dia resp!`)
        }, 
      },
      ...
      { 
        ...
        display: { caption: `Hi there, aku adalah bulan yg menyinari hari malam mu tapi aku tak seindah matamu!` },
      },
    ],
  }
